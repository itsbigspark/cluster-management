...
public class HadoopKeyStoreHelper {
  ...
  public static List<String> getAliasesFromHadoopKeyStore(SparkSession spark, String pathToKeyStore)
  ...
  public static String getFromHadoopKeyStore(SparkSession spark, String pathToKeyStore,
  ...
  public static void writeToHadoopKeyStore(SparkSession spark, String pathToKeyStore,
      String passwordAlias, String password)
      throws URISyntaxException, IOException, InterruptedException {
    CredentialProvider cp = HadoopKeyStoreHelper.getCredentialProvider(spark, pathToKeyStore);
  ...
  private static CredentialProvider getCredentialProvider(SparkSession spark, String pathToKeyStore)
