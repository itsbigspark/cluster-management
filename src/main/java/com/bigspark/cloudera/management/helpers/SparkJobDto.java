...
public class SparkJobDto {
    ...
    public SparkJobDto(BigInteger jobId, String name, String submissionTime, String completionTime, BigInteger[] stageIds, BigInteger jobGroup, String status, BigInteger numTasks, BigInteger numActiveTasks, BigInteger numCompletedTasks, BigInteger numSkippedTasks, BigInteger numFailedTasks, BigInteger numKilledTasks, BigInteger numCompletedIndices, BigInteger numActiveStages, BigInteger numCompletedStages, BigInteger numSkippedStages, BigInteger numFailedStages, String[] killedTasksSummary) {
        this.jobId = jobId;
        this.name = name;
