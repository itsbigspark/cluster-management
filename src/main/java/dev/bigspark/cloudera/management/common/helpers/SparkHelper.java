...
import dev.bigspark.hadoop.helpers.HadoopKeyStoreHelper;
...
/**
 * Entry point facade class to aid with complex operations within a SparkSession not supported by
 * Spark DataFrame operations. Examples include 1. HDFS operations (read, write delete files, manage
 * directories etc.) 2. Security operations (read and write to secure JCEKS stores)
 *
 * @author Rich Hay
 */
public class SparkHelper {
    ...
    public static class Hdfs {
         ...
         * @throws IOException
         */
        public static void appendFileContent(String targetPath, String fileName, String payload)
         ...
         * @throws IOException
         */
        public static void writeFileContent(String targetPath, String fileName, String payload)
                throws IllegalArgumentException, IOException {
    ...
    public static class Security {
         ...
         * @throws InterruptedException
         */
        public static List<String> getAliasesFromHadoopKeyStore(String pathToKeyStore)
                throws URISyntaxException, IOException, InterruptedException {
            return HadoopKeyStoreHelper
                    .getAliasesFromHadoopKeyStore(SparkHelper.getSparkSession(), pathToKeyStore);
        }
         ...
         * @throws InterruptedException
         */
        public static String getFromHadoopKeyStore(String pathToKeyStore, String passwordAlias)
                throws URISyntaxException, IOException, InterruptedException {
            return HadoopKeyStoreHelper
                    .getFromHadoopKeyStore(SparkHelper.getSparkSession(), pathToKeyStore, passwordAlias);
        }
         ...
         * @throws InterruptedException
         */
        public static void writeToHadoopKeyStore(String pathToKeyStore, String passwordAlias,
                                                 String password) throws URISyntaxException, IOException, InterruptedException {
            HadoopKeyStoreHelper
                    .writeToHadoopKeyStore(SparkHelper.getSparkSession(), pathToKeyStore, passwordAlias,
                            password);
        }
    }
