...
drop table if exists bddlsold01d.sys_cm_housekeeping;
CREATE TABLE IF NOT EXISTS  bddlsold01d.sys_cm_housekeeping (db_name STRING, tbl_name STRING, retention_period INT, retain_month_end STRING, processing_group INT, active STRING);
INSERT INTO  bddlsold01d.sys_cm_housekeeping VALUES ('bddlsold01d','test_table_sh',10,'true',1,'true');
INSERT INTO  bddlsold01d.sys_cm_housekeeping VALUES ('bddlsold01d','test_table_sh2',10,'false',1,'true');


select * from bddlsold01d.sys_cm_housekeeping
